...
You will receive a photo of a specific body part: {{{bodyPart}}}.
...
1.  **Subject Requirement:** The image's main subject MUST be a clear, close-up view of the specified human body part: {{{bodyPart}}}. If the picture is mostly showing this, it is valid.
...
1.  **Validation:**
    ...
    - Next, you MUST determine if the image is valid by strictly applying the two rules above for the specified {{{bodyPart}}}.
...
2.  **Description and Analysis:**
    ...
    - **If the image is invalid:**
        ...
        - The 'description' MUST explain why it's invalid. Examples:
          - "This is a photo of a car. To check for anemia, a clear, close-up picture of the {{{bodyPart}}} is required."
