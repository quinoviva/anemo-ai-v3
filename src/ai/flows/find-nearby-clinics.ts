  ...
  async ({query}) => {
    ...
    console.log(`Simulating search for: ${query}`);
     const simulatedResults = [
        ...
        { name: 'St. Paul’s Hospital Iloilo', type: 'Hospital', address: 'Gen. Luna St., Iloilo City', contact: '(033) 337-2741', hours: '24/7', website: 'https://sphiloilo.com/', notes: 'A private Catholic hospital managed by the Sisters of Saint Paul of Chartres.'},
