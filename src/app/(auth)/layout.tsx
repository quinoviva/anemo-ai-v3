    ...
    <div className="flex min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-16 max-w-xl text-center">
          ...
          >
            {/* Using foreground-based colors ensures visibility on both light and dark backgrounds */}
            <div className="h-28 w-28 rounded-[2rem] bg-foreground/5 backdrop-blur-2xl border border-foreground/10 flex items-center justify-center shadow-2xl ring-1 ring-foreground/20">
          ...
          <motion.h1
            ...
            className="text-6xl font-light tracking-tight text-foreground mb-8 leading-tight drop-shadow-sm"
          >
          ...
          <motion.p
            ...
            className="text-xl text-muted-foreground font-light leading-relaxed tracking-wide"
          >
            Advanced anemia screening powered by clinical-grade AI and computer vision.
        ...
        <motion.div
          ...
          className="absolute bottom-12 left-12 right-12 flex justify-between text-xs text-muted-foreground/50 uppercase tracking-[0.2em] font-medium"
        >
          <span>Anemo © 2026</span>
      ...
      <div className="flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-[520px] p-6 md:p-12 relative z-10">
          {/* Mobile Logo Show */}
          <div className="lg:hidden flex flex-col items-center mb-10 gap-4">
            ...
            <h1 className="text-7xl font-light text-foreground tracking-tighter">ANEMO</h1>
          </div>
