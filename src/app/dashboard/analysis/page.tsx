            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
              ...
              <motion.div variants={itemVariants} className="hidden md:block">
                <div className="text-right">
                  <p className="text-[10px] font-black tracking-[0.4em] text-muted-foreground">CONVOLUTIONAL NEURAL NETWORK</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="pt-8 md:pt-12 text-center">
              <div className="flex items-center gap-4 mb-8 px-2">
                ...
                <div className="flex items-center gap-2 text-primary/60">
                  <span className="text-[9px] md:text-[10px] font-black tracking-[0.2em] md:tracking-[0.3em]">Powered by ANEMO</span>
                </div>
                <div className="h-px flex-1 bg-gradient-to-r from-transparent via-primary/20 to-transparent" />
              </div>
            </div>
